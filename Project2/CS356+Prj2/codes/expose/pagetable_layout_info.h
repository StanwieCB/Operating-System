...
{
	uint32_t pgdir_shift; 		//physical address of second-level page table
	uint32_t pmd_shift; 		//physical address of third-level page table
	uint32_t page_shift; 		//shift amount
};
#endif